...
/**
 * @author Daisuke Kusuda Playerクラス：すごろくのプレイヤー情報格納
 */
class Player {
	...
	/**
	 * GOALを超えた数(int型)をフィールド変数を減算するメソッド
	 * 
	 * @param num GOALを超えた数
	 */
...
/**
 * @author Daisuke Kusuda SugorokuAnswer02クラス:すごろくを実行するクラス
 */
public class SugorokuAnswer03 {
	...
	public static void main(String[] args) {
		try {
			...
			// SugorokuAnswer03を生成
			SugorokuAnswer03 sugo = new SugorokuAnswer03();
	...
	/**
	 * サイコロを降る前のコマ数から進んだコマ数を足し 現在情報（playerインスタンスの名前とコマ数）を表示し、終了フラグを管理するメソッド
	 * 
